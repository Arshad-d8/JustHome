...
export default function BlackSearch() {
  return (
    <div className='bg-[#1A1A1A] md:h-20 md:w-200 mx-10 md:m-auto my-5 md:my-0 md:-mt-10 content-center rounded-3xl'>
      <form className='flex flex-col md:flex-row justify-between items-center gap-3  px-5 py-4 md:py-0'>
