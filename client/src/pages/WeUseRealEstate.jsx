...
export default function WeUseRealEstate() {
    return (
        <div className='flex flex-col md:flex-row justify-between md:h-screen px-10 md:px-35 my-20 gap-20'>
            <div className='flex flex-col justify-center gap-10 md:w-1/2'>
                <p className='text-4xl font-semibold'>We Use Real Estate to Show <br />Our Appreciation of The <br />World</p>
